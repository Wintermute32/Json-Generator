...
namespace JsonValidator
{
  ...
  {
		public PrizeBox(FlowLayoutPanel flowPanel, IPrizeBox prize)
		{
			GroupBox newGroupB = GeneratePrizePops();
			AddToFlowPanel(flowPanel, newGroupB);
			AssignComboBoxText(prize, newGroupB);
			
		}
		private GroupBox GeneratePrizePops()
		{           
